...
define ('TEST',true); // true na PRODUCAO!
...
$translate = [
  ...
  'condo-estatuto2009'=> 'condo-estatuto2009-v1.lex1.htm',
  'okbr-estatuto'=>      'okbr-estatuto2013-v1.lex1.htm',
...
elseif (!in_array($domDtd,$dtds))   // see conf.php
  dieMsg("arquivo $pathFile, DTD '$domDtd' desconhecida",5);
elseif ($domDtd!='html5-lex1')
dieMsg("DESCULPE, dtd '$domDtd' inválida só estamos trabalhando com html5-lex1, use conversão dtdConvert.php",6);
